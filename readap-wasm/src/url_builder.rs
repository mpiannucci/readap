...
use readap::{Constraint, IndexRange, UrlBuilder as ReadapUrlBuilder};
...
impl UrlBuilder {
    ...
    pub fn add_multidimensional_constraint(
        self,
        variable: &str,
        indices: &Array,
    ) -> Result<UrlBuilder, JsValue> {
        let mut index_ranges = Vec::new();
        ...
        Ok(UrlBuilder {
            inner: self
                .inner
                .add_multidimensional_constraint(variable, index_ranges),
        })
    }
