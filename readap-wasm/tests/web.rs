...
fn test_url_builder_multidimensional() {
    let builder = UrlBuilder::new("https://example.com/data.nc").add_variable("temp");
    ...
    let builder = builder
        .add_multidimensional_constraint("temp", &constraints)
...
fn test_url_builder_clone() {
    let builder1 = UrlBuilder::new("https://example.com/data.nc").add_variable("temp");
